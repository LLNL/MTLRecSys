...
# path_to_hierarchical_data = '../datasets_preprocessing/hierarchical_datasets.pkl'

path_to_output = '../outputs'
path_to_datasets = '../datasets/pickle_files/'
path_to_mappings = '../auxiliary_files/mappings/'
